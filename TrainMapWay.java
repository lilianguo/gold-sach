    ...
    private static class TrainMap {
       ...
       */
        ...
        while(!queue.isEmpty()) {
          ...
          for (Station neighbor : curr.neighbours) {
            if (!howWeReachEnd.containsKey(neighbor)) {
              queue.add(neighbor);
              howWeReachEnd.put(neighbor, curr);
            }
          }
        }
        ...
        while(destination != null) {
          ...
          destination = howWeReachEnd.get(destination);
        }

        return Collections.reverse(shortestPath);
      }
